...
class Facebook extends AbstractService
{
     ...
     * Defined scopes
     *
     * If you don't think this is scary you should not be allowed on the web at
     * all
     *
     * @link https://developers.facebook.com/docs/reference/login/
     * @link https://developers.facebook.com/tools/explorer For a list of
     *     permissions use 'Get Access Token'
     */
    // email scopes
